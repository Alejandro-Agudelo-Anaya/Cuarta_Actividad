...
class VentanaPrincipal extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent evento) {
        if (evento.getSource() == calcular) {
            ...
            double mayorNota = notas.calcularMayor();
            double menorNota = notas.calcularMenor();

            promedio.setText("Promedio = " + String.format("%.2f", prom));
            desviación.setText("Desviación estándar = " + String.format("%.2f", desv));
            mayor.setText("Nota mayor = " + String.valueOf(mayorNota));
            menor.setText("Nota menor = " + String.valueOf(menorNota));
        }
